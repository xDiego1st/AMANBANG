                ...
                <div class="nk-block-between">
                    <div class="nk-block-head-content">
                        <h3 class="nk-block-title page-title">
                            <small>Daftar Kinerja Operator - Verifikator</small>
                        </h3>
                                    ...
                                    <div class="form-inline flex-nowrap gx-3">
                                        <div class="form-wrap w-150px" wire:ignore>
                                            <select class="form-select js-select2" data-search="on"
                                                ...
                                                <option value="sendWA">Send WA</option>
                                            </select>
                                        </div>
                                        <div class="btn-wrap">
                        ...
                        <div class="p-0 card-inner table-responsive table-bordered is-compact">
                            <div class="nk-tb-list nk-tb-ulist">
                                <div class="nk-tb-item nk-tb-head">
                                    ...
                                    <div class="text-center nk-tb-col"><span class="sub-text">Verifikator</span></div>
                                    <div class="nk-tb-col"><span>Role</span></div>
                                    <div class="nk-tb-col"><span>Total Pengajuan</span></div>
                                    <div class="nk-tb-col"><span>SOP</span></div>
                                    <div class="nk-tb-col"><span>Melewati SOP</span></div>
                                    ...
                                    <div class="nk-tb-item" wire:key="{{ $i->id }}">
                                        ...
                                        <div class="nk-tb-col">
                                            <div class="user-card">
                                                ...
                                                @endif
                                                <div class="user-info">
                                                    <span class="link-on-info">{{ $i->name }}
                                        ...
                                        <div class="nk-tb-col">
                                            ...
                                            <span
                                                class="badge {{ $i->type_validator_color() }}">{{ $i->type_validator_name() }}</span>
                                            <span class="badge badge-dim bg-primary">{{ $i->jenis_user }}</span>
                                        </div>
                                        <div class="nk-tb-col">
                                            <span class="badge bg-primary">{{ $i->verifikator->count() }} Total
                                                Pengajuan</span>
                                            <span class="badge badge-dim bg-success">{{ $i->verifikator->count() }}
                                                Terverifikasi</span>
                                            <span class="badge badge-dim bg-danger">{{ $i->verifikator->count() }}
                                                Belum Terverifikasi</span>
                                        </div>
                                        <div class="nk-tb-col">
                                            <span class="badge bg-secondary">{{ $i->roleSop() }}</span>
                                            <br>
                                            <small><span>Proses Penerbitan KRK / Validasi</span></small>
                                        </div>
                                        <div class="nk-tb-col">
                                            <span class="badge bg-outline-secondary">0
                                                Pengajuan</span>
                                        </div>
                                        <div class="nk-tb-col nk-tb-col-tools">
