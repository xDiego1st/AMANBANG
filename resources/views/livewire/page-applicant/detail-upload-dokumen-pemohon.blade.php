    ...
    <div class="nk-block">
        <div class="row gy-5">
            <div class="col-lg-5">
                ...
                @if ($this->data->status == '2' && $user->role == 'PEMOHON')
                    <div class="card">
                        <div class="card-inner">
                            <div class="nk-block-head">
                                <div class="nk-block-head-content">
                                    <h5 class="nk-block-title title"> Re-Uploaded Documents</h5>
                                    <p>Upload File Dokumen Yang sudah Di-perbaiki dibawah berikut : </p>
                                </div>
                            </div><!-- .nk-block-head -->
                            <div class="card card-bordered">
                                <ul class="data-list is-compact">
                                    ...
                                    <button type="button"
                                        ...
                                        wire:click="submit_reupload" wire:loading.attr="disabled" wire:target="submit_reupload">
                                        {{-- Icon normal --}}
                                        <em class="icon ni ni-check-circle me-1" wire:loading.remove
                                            wire:target="submit_reupload"></em>
                                        {{-- Spinner saat loading --}}
                                        <span class="spinner-border spinner-border-sm me-1" role="status"
                                            aria-hidden="true" wire:loading wire:target="submit_reupload"></span>

                                        <span wire:loading.remove wire:target="submit_reupload">Submit Dokumen</span>
                                        <span wire:loading wire:target="submit_reupload">Memproses...</span>
                                    </button>
                ...
                <div class="col-lg-7">
                    <div class="card">
                        <div class="card-inner">
                            <div class="nk-block-head">
                                <div class="nk-block-head-content">
                                    <h5 class="nk-block-title title">Informasi Upload
                                        {{ $data->type_dokumen->nama_dokumen }}
                                    </h5>
                    ...
                    @if ($data->status == '2')
                        <hr>
                        <div class="card-bordered" wire:ignore>
                            <div id="corecction-accordion" class="accordion">
                                <div class="accordion-item">
                                    <a href="javascript:void(0)" class="accordion-head" data-bs-toggle="collapse"
                                        data-bs-target="#cor-q1">
                                        <h6 class="title">File Catatan Koreksi Verifikator
                                            <small><small>| Di Upload Pada :
                                                    {{ convert_date2($data->updated__at) }}</small></small>
                                        </h6>
                                        <span class="accordion-icon"></span>
                                    </a>
                                    <div class="accordion-body collapse" id="cor-q1"
                                        data-bs-parent="#corecction-accordion">
                                        <div class="accordion-inner">
                                            <embed src="{{ $data->getFirstMediaUrl('upload_correction_verifikator') }}"
                    ...
                    <div class="nk-block-head">
                        <div class="justify-between nk-block-head-content d-flex align-items-center">
                            <h5 class="mb-0 nk-block-title title">
                                Informasi Keterangan {{ $data->type_dokumen->nama_dokumen }}
                            </h5>
                            ...
                            <button type="button" class="btn btn-sm btn-primary d-inline-flex align-items-center"
                                ...
                                <span class="spinner-border spinner-border-sm me-1" role="status" aria-hidden="true"
                                    wire:loading wire:target="checkAll"></span>
        ...
        <hr>
        @if ($data->status == '0' && $user->role == 'PEMOHON')
            ...
            <div id="faqs" class="accordion">
                <div class="accordion-item">
                    <a href="javascript:void(0)" class="accordion-head" data-bs-toggle="collapse"
                        ...
                        <h6 class="title">{{ $data->type_dokumen->nama_dokumen }}
                            <small><small>| Di Upload Pada : {{ convert_date2($data->created_at) }}</small></small>
                        </h6>
                        <span class="accordion-icon"></span>
                    </a>
                    <div class="accordion-body collapse show" id="faq-q1" data-bs-parent="#faqs">
                        <div class="accordion-inner">
                            <embed src="{{ $data->getFirstMediaUrl($dok_name) }}" type="application/pdf"
